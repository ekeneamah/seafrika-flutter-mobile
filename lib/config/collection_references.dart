...
class CollectionReferences {
  ...
  static Query<Map<String, dynamic>> productsForCategory(
          String businessId, String category) =>
      productsForBusiness(businessId).where('category', isEqualTo: category);

  static Query<Map<String, dynamic>> activeProductsForBusiness(
          String businessId) =>
      productsForBusiness(businessId).where('status', isEqualTo: 'active');
  ...
  static Query<Map<String, dynamic>> searchProductsByName(
          String businessId, String searchTerm) =>
      productsForBusiness(businessId)
          .orderBy('name')
  ...
  static Query pendingOrders(String businessId) =>
      ordersForBusiness(businessId).where('status', isEqualTo: 'pending');

  static Query ordersByDateRange(
  ...
  static Query activeCustomers(String businessId) =>
      customersForBusiness(businessId).where('isActive', isEqualTo: true);
  ...
  static Query<Map<String, dynamic>> inventoryForStore(
          String businessId, String storeId) =>
      inventory
          .where('businessId', isEqualTo: businessId)
          .where('storeId', isEqualTo: storeId);

  static Query<Map<String, dynamic>> activeInventoryForStore(
          String businessId, String storeId) =>
  ...
  static Query<Map<String, dynamic>> lowStockInventoryForStore(
          String businessId, String storeId) =>
      inventoryForStore(businessId, storeId)
          .where('quantity', isLessThanOrEqualTo: 'lowStockThreshold');

  static Query<Map<String, dynamic>> searchInventoryByName(
          String businessId, String storeId, String searchTerm) =>
      inventoryForStore(businessId, storeId)
          .orderBy('productName')
          .startAt([searchTerm]).endAt([searchTerm + '\uf8ff']);

  static Query<Map<String, dynamic>> inventoryByCategory(
          String businessId, String storeId, String category) =>
      inventoryForStore(businessId, storeId)
  ...
  static Query<Map<String, dynamic>> businessInventoryForBusiness(
          String businessId) =>
      businessInventory.where('businessId', isEqualTo: businessId);

  static Query<Map<String, dynamic>> activeBusinessInventory(
          String businessId) =>
      businessInventoryForBusiness(businessId)
          .where('status', isEqualTo: 'active');

  static Query<Map<String, dynamic>> lowStockBusinessInventory(
          String businessId) =>
      businessInventoryForBusiness(businessId)
          .where('availableQuantity', isLessThanOrEqualTo: 10);

  static Query<Map<String, dynamic>> searchBusinessInventoryByName(
          String businessId, String searchTerm) =>
      businessInventoryForBusiness(businessId)
          .orderBy('productName')
          .startAt([searchTerm]).endAt([searchTerm + '\uf8ff']);

  static Query<Map<String, dynamic>> businessInventoryByCategory(
          String businessId, String category) =>
      businessInventoryForBusiness(businessId)
          .where('category', isEqualTo: category);
  ...
  static Query<Map<String, dynamic>> costPriceHistoryForBusiness(
          String businessId) =>
      costPriceHistory.where('businessId', isEqualTo: businessId);

  static Query<Map<String, dynamic>> costPriceHistoryForItem(
          String businessInventoryId) =>
      costPriceHistory.where('businessInventoryId',
          isEqualTo: businessInventoryId);

  static Query<Map<String, dynamic>> activeCostPriceHistory(
          String businessId) =>
      costPriceHistoryForBusiness(businessId)
          .where('status', isEqualTo: 'active');

  static Query<Map<String, dynamic>> costPriceHistoryByDateRange(
          String businessId, DateTime start, DateTime end) =>
      costPriceHistoryForBusiness(businessId)
  ...
  static Query activeStaff(String businessId) =>
      staffForBusiness(businessId).where('status', isEqualTo: 'active');
  ...
  static Query tasksForUser(String businessId, String userId) =>
      tasksForBusiness(businessId).where('assignedTo', arrayContains: userId);

  static Query pendingTasks(String businessId) =>
      tasksForBusiness(businessId).where('status', isEqualTo: 'pending');
  ...
  static Query activeSuppliers(String businessId) =>
      suppliersForBusiness(businessId).where('status', isEqualTo: 'active');
  ...
  static Query purchaseOrdersForSupplier(
  ...
  static Query reviewsForProduct(String businessId, String productId) =>
      reviewsForBusiness(businessId).where('productId', isEqualTo: productId);

  static Query pendingReviews(String businessId) =>
      reviewsForBusiness(businessId).where('status', isEqualTo: 'pending');
  ...
  static Query analyticsForTimeframe(String businessId, String timeframe) =>
      analyticsForBusiness(businessId).where('timeframe', isEqualTo: timeframe);

  static Query analyticsForType(String businessId, String type) =>
      analyticsForBusiness(businessId).where('type', isEqualTo: type);
  ...
  static Query activeStores(String businessId) =>
      storesForBusiness(businessId).where('isActive', isEqualTo: true);
  ...
  static Query activeTeams(String businessId) =>
      teamsForBusiness(businessId).where('status', isEqualTo: 'active');
  ...
  static Query pendingBookings(String businessId) =>
      bookingsForBusiness(businessId).where('status', isEqualTo: 'pending');
  ...
  static Query activeIntegrations(String businessId) =>
      integrationsForBusiness(businessId).where('isActive', isEqualTo: true);

  static Query activeIntegrationsForPlatform(
          String businessId, String platform) =>
