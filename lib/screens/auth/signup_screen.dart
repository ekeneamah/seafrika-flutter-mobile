...
class _SignupScreenState extends ConsumerState<SignupScreen>
  ...
  bool _isBusinessAddressValid = false;
  ...
  void initState() {
    ...
    _businessNameController.addListener(_validateBusinessNameRealTime);
    ...
    _businessAddressController.addListener(_validateBusinessAddressRealTime);
  }
  ...
  void _validateBusinessNameRealTime() {
    final value = _businessNameController.text.trim();
    final isValid = value.isNotEmpty && 
        value.length >= 2 && 
        value.length <= 20;
    
    if (_isBusinessNameValid != isValid) {
      setState(() {
  ...
  void _validateBusinessAddressRealTime() {
    final value = _businessAddressController.text.trim();
    final isValid = value.isNotEmpty && value.length >= 4;
     print('Validation: "$value" → isValid: $isValid');
    
    if (_isBusinessAddressValid != isValid) {
      setState(() {
        _isBusinessAddressValid = isValid;
      });
    }
  }
  ...
  @override
  void dispose() {
     _businessAddressController.removeListener(_validateBusinessAddressRealTime);
    ...
    _businessNameController.removeListener(_validateBusinessNameRealTime);
    _fadeController.removeListener(() {});
  ...
  Future<void> _signup() async {
    ...
    if (_selectedCountry == null || _selectedState == null) {
      _showSnackBar('Please select your country and state.', isError: true);
      return;
    }
  ...
  Widget _buildModernCard({required Widget child, EdgeInsets? padding}) {
    return Container(
      ...
      margin: const EdgeInsets.symmetric(horizontal: 16), // Reduced horizontal margin
      padding: padding ?? const EdgeInsets.all(24), // Reduced padding for more field space
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _buildSuffixIcon(isValid: _isBusinessNameValid),
              ),
              validator: (value) {
                ...
                if (value.trim().length > 20) {
                  return 'Business name must be at most 20 characters';
                }
                return null;
              },
            ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _buildSuffixIcon(isValid: _isNameValid),
              ),
              validator: (value) {
                if (value == null || value.trim().isEmpty) {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _buildSuffixIcon(isValid: _isBusinessAddressValid),
              ),
              validator: (value) {
                if (value == null || value.trim().isEmpty) {
                ...
                if (value.trim().length < 4) {
                  return 'Business address must be at least 4 characters';
                }
                return null;
              },
            ),
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _buildSuffixIcon(isValid: _selectedCountry != null),
              ),
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _buildSuffixIcon(isValid: _selectedState != null),
              ),
  ...
  Widget _buildLoginPrompt() {
    return Container(
      width: double.infinity, // Full width
      margin: const EdgeInsets.symmetric(horizontal: 16), // Consistent with card margins
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
