...
import { WhatsAppWebhookDto, WhatsAppWebhookEntryDto } from '../shared/dto/whatsapp-webhook.dto';

// Define WhatsApp message type inline since we removed the external types
